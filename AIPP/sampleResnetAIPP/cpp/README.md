...
## 样例运行
  ...
  - 数据准备
    ...
    ```    
    cd $HOME/samples/inference/modelInference/sampleResnetAIPP/cpp/data
  ...
  - ATC模型转换
    ...
    cd $HOME/samples/inference/modelInference/sampleResnetAIPP/cpp/model
  ...
  - 样例编译
    ...
    ```
    cd $HOME/samples/inference/modelInference/sampleResnetAIPP/cpp/scripts
...
## 更新说明
  | 时间 | 更新事项 |
|----|------|
| 2023/02/17 | 新增sampleResnetAIPP/cpp/README.md |

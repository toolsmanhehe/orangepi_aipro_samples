...
Result VencProcess::CreatePicDesc()
{
    ...
    ACL_REQUIRES_OK(acldvppSetPicDescFormat(inputPicputDesc_, format_));
    ACL_REQUIRES_OK(acldvppSetPicDescWidth(inputPicputDesc_, 128));
    ACL_REQUIRES_OK(acldvppSetPicDescHeight(inputPicputDesc_, 128));
    ACL_REQUIRES_OK(acldvppSetPicDescWidthStride(inputPicputDesc_, 128));
    ACL_REQUIRES_OK(acldvppSetPicDescHeightStride(inputPicputDesc_, 128));
    return SUCCESS;
}

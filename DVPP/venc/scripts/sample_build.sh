...
{
  cd ${ScriptPath}/../
  if [ ! -f "./data/dvpp_vpc_1920x1080_nv12.yuv" ];then
    echo "[INFO] Start data prepare"
    wget -O ./data/dvpp_vpc_1920x1080_nv12.yuv https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/venc/dvpp_vpc_1920x1080_nv12.yuv --no-check-certificate
  fi
}

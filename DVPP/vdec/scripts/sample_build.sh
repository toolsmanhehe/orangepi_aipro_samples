...
{
  cd ${ScriptPath}/../
  if [ ! -f "./data/vdec_h265_1frame_rabbit_1280x720.h265" ];then
    echo "[INFO] Start data prepare"
    wget -O ./data/vdec_h265_1frame_rabbit_1280x720.h265 https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/vdec/vdec_h265_1frame_rabbit_1280x720.h265 --no-check-certificate
  fi
}

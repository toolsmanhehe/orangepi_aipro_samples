...
{
  cd ${ScriptPath}/../
  if [ ! -f "./data/wood_rabbit_1024_1068_nv12.yuv" ];then
    echo "[INFO] Start data prepare"
    wget -O ./data/wood_rabbit_1024_1068_nv12.yuv https://obs-9be7.obs.cn-east-2.myhuaweicloud.com/models/crop/wood_rabbit_1024_1068_nv12.yuv --no-check-certificate
  fi
}
